...
class TaskType(str, Enum):
    ...
    PHOTOSHOP_IMPORT = "photoshop_import" # Pipeline E: Photoshop 导入
    PHOTOSHOP_EXPORT = "photoshop_export" # Pipeline E: Photoshop 导出
    BRIDGE_SYNC = "bridge_sync"   # [新增] Bridge 同步信号
