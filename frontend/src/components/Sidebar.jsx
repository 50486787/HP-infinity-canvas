...
const Sidebar = ({ activeTool, onToolSelect, onAddObject, onOpenSettings }) => {
    ...
    <aside className="h-screen w-[72px] bg-white border-r border-gray-200 flex flex-col items-center py-6 select-none z-50 shrink-0">
      ...
      <div className="mt-auto flex flex-col gap-4 px-3 w-full">
        <button 
          ...
          className="flex items-center justify-center w-full aspect-square rounded-xl text-gray-500 hover:bg-gray-100" 
          title="画布设置 (吸附/网格)"
        >
           <Settings size={20} />
        </button>
